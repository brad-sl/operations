...
| `phase6-marketdata-btc-1d` `c2753e10a9c9` | **CW-1 D3/D4 sensor** · thin universe 1d → `data/marketdata.db` (held∪basket∪tryout∪BTC/ETH/PAXG) + freshness + refresh `regime_cash_status` · **07:40 PT daily** · TG short · **no knobs / no unpark** · live cutover: arm-switch + run-phase prefer store · plan `docs/plans/2026-09-22-marketdata-ohlcv-schema-design.md` |
