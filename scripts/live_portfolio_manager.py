...
class LivePortfolioManager:
    ...
    def get_positions(self) -> Dict[str, float]:
        ...
        try:
            # Prefer live query if client supports it (live mode)
                ...
                if accounts:
                    ...
                    for acc in acc_list:
                        ...
                        for pair in ["BTC-USD", "ETH-USD", "SOL-USD", "XRP-USD", "DOGE-USD"]:
                            ...
                            if currency == base:
                                bal = float(
                                    acc.get("available_balance", {}).get("value", 0)
            ...
            # Fallback ONLY for paper mode or if live query failed
