...
class Phase5Harness:
    POSITION_MANAGER = None  # Will initialize in __init__
    POSITION_MANAGER = PositionStateManager()  # Singleton for state tracking
    def __init__(self, config_path=None):
        ...
        self.sl_placer = SLPlacement(self.cb_client)  # For SL order placement
    ...
    def _execute_trade(self, pair, signal, price):
        ...
        try:
            ...
            try:
                ...
                if order_id and hasattr(self, 'sl_placer'):
                    try:
