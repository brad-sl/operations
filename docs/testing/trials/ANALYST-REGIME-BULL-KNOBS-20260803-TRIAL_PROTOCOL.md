# Protocol — ANALYST-REGIME-BULL-KNOBS-20260803-TRIAL

**Master task:** `ANALYST-REGIME-BULL-KNOBS-20260803`  
...
python3 phase6/research/trial_cycle.py status ANALYST-REGIME-BULL-KNOBS-20260803-TRIAL
```
