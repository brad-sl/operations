# Protocol — ANALYST-REGIME-FLAT-KNOBS-20260730-TRIAL

**Master task:** `ANALYST-REGIME-FLAT-KNOBS-20260730`  
...
python3 phase6/research/trial_cycle.py status ANALYST-REGIME-FLAT-KNOBS-20260730-TRIAL
```
