...
class Phase6TradingBot:
    ...
    def __init__(self, config_path: str, mode: str = 'PAPER_TRADE', sandbox: bool = True):
        """
        ...
        self.sl_pct = self.config.risk_management.stop_loss_pct / 100  # 2% = 0.02
        self.tp_pct = self.config.risk_management.take_profit_pct / 100  # 5% = 0.05
